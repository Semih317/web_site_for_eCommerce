...
const LamPanel = () => {
    ...
    useEffect(() => {
        const filteredPanels = panels.filter(panel => panel.model === "Lam Kaplı Panel");
            ...
            <div className="body-top">
                <div className="body-top-column">
                    ...
                    <div className="body-top-column-text">
                        <span className="marco-polo">Lam Kaplı Panel</span>
                        <p className="marco-polo-bottom">Sequoia Lam Kaplı Paneller,kolay temizlenme, hızlı ve kolay montaj, çizilmeye ve UV ışınlarına karşı dayanıklı yapısıyla yaşam alanlarında oldukça çok tercih edilir. Birbirinden farklı renk ve desenlere sahip olan Sequoia MDF Lam Paneller eşsiz bir tasarım ve dekorasyon yapmanıza olanak sunar.</p>
                    </div>
                </div>
                <div className="body-top-text flex justify-between gap-16">
                    <div className="text1">
                        <span>EO, Antibakteriyel, EPD, CE, TSCA CARB II, Entegre Yönetim Sistemleri Sertifikaları Sequoia Lam Kaplı Panellerin güvenilirliğini ve kalitesini gösterir. Sürdürülebilirlik politikaları gereği Sequoia, MDF Lam Panel üretimi yaparken çevre dostu bir politikayla hareket eder.</span>
                    </div>
                    <div className="text2">
                        <span>Sequoia Lam Kaplı Panellerin fiyatları kullanılacak alana göre, mdf lam panel ebatı, deseni ve özelliklerine göre farklılık gösterir.</span>
                    </div>
                </div>
            </div>
